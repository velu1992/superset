 ...
 * under the License.
 */
import { SupersetPluginChartThreeDimentionalFunctionalPlot } from '../src';
 ...
 */
describe('superset-plugin-chart-three-dimentional-functional-plot', () => {
  it('exists', () => {
    expect(SupersetPluginChartThreeDimentionalFunctionalPlot).toBeDefined();
  });
});
