...
interface SupersetPluginChartThreeDimentionalFunctionalPlotCustomizeProps {
  headerText: string;
}

export type SupersetPluginChartThreeDimentionalFunctionalPlotQueryFormData = QueryFormData &
